...
// Add an annotation to the Measurement Entity:

public class Measurement {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy=GenerationType.AUTO,generator="meaIdGen")
    @SequenceGenerator(name="meaIdGen", sequenceName="MEA_SEQ", allocationSize=1)
