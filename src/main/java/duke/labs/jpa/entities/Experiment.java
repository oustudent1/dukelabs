...
// Add an annotation to the Experiment Entity:

public class Experiment {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy=GenerationType.AUTO, generator="expIdGen")
    @SequenceGenerator(name="expIdGen", sequenceName="EXP_SEQ", allocationSize=1)
    private int id;
